...
public class AppMain {
    ...
    public static final String POEM_D = "This This This This This This";

    /* Project Goal
     *  You are writing a program to compute statistics about the word use in poems.
     * The program should take a poem (as a single String) and output (to the console) 
    ...
    public static void main(String[] args) {
        ...
        print.printPoem(list, count, temp, POEM_C);
    }
}
