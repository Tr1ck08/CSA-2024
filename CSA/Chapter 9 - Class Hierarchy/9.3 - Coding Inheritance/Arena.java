public class Arena {
    ...
    private Creature nextCreature() {
        ...
        Creature[] creatures = {new FastCreature("Snugglewight(Fast)"), new StrongCreature("Quillfluff(Strong)"), new AccurateCreature("Tanglethorn(Accurate)"), new FastCreature("Puffernip(Fast)"), new FastCreature("Shagglewisp(Fast)"), new StrongCreature("Fuzzlenook(Strong)"),new AccurateCreature("Whiskerwhisp(Accurate)"), new StrongCreature("Fluffletuft(Strong)")};
        return creatures[creatureIndex-1];
